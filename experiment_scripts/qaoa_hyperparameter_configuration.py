...
def main():
    ...
    def target_function(config: Configuration, instance: str, seed: int):
        ...
        def solve(hamiltonian):
            ...
            solver = QAOA(sampler=sampler_primitive, optimizer=optimizer, aggregation=0.5, reps=config["repetitions"])
        ...
        with Client(scheduler_file="qaoa_scheduler.json") as client:
    ...
    with (
        ...
        with (
            ...
            calculation_client.write_scheduler_file("qaoa_scheduler.json")
